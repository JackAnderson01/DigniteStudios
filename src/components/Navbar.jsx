  ...
  return (
    ...
    >
      ...
      <div className="w-auto flex gap-6 justify-start items-center">
        ...
        <Link
          to="/contact-us"
          className="cursor-pointer w-32 lg:w-48 h-10 lg:h-12 rounded-md flex justify-center items-center bg-gradient-to-r from-[#f15c20] to-[#e00e2dd8] transition-all duration-200 hover:opacity-90 uppercase outline-none border-none text-white text-[12px] lg:text-[16px] font-bold"
        >
          Get a Quote
        </Link>
        <button
